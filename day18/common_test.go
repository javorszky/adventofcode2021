...
func Test_addNodes(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "task 2 largest",
			args: args{
				left:  "[[[[5,4],[7,7]],8],[[8,3],8]]",
				right: "[[[0,[5,8]],[[1,7],[9,6]]],[[4,[1,2]],[[1,4],2]]]",
			},
			want: "[[[[7,9],[7,8]],[[8,3],8]],[[[7,7],[7,7]],[[6,6],[6,6]]]]",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_node_Magnitude(t *testing.T) {
	tests := []struct {
		...
		{
			name: "[[[[7,8],[6,6]],[[6,0],[7,7]]],[[[7,8],[8,8]],[[7,9],[0,6]]]]",
			in:   "[[[[7,8],[6,6]],[[6,0],[7,7]]],[[[7,8],[8,8]],[[7,9],[0,6]]]]",
			want: 3993,
		},
		{
			name: "[[[[7,9],[7,8]],[[8,3],8]],[[[7,7],[7,7]],[[6,6],[6,6]]]]",
			in:   "[[[[7,9],[7,8]],[[8,3],8]],[[[7,7],[7,7]],[[6,6],[6,6]]]]",
			want: 4005,
		},
	}
	for _, tt := range tests {
...
func Test_parse_reparse(t *testing.T) {
	tests := []string{
	...
	for _, tt := range tests {
		t.Run(tt, func(t *testing.T) {
			assert.Equalf(t, tt, parse(tt).String(), "parse(%v)", tt)
		})
	}
}
